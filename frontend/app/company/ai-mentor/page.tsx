...
export default function AiMentorPage() {
  ...
  const quickActions: QuickAction[] = [
    {
      icon: <FaChartLine />,
      title: t("aiMentor.applicantInsights"),
      description: t("aiMentor.applicantInsightsDesc"),
      action: () => sendMessage(t("aiMentor.applicantInsightsRequest")),
      gradient: "linear-gradient(135deg, var(--gradient-blue-start, #58a6ff) 0%, var(--gradient-blue-end, #1f6feb) 100%)",
    },
    {
      icon: <FaBriefcase />,
      title: t("aiMentor.hiringAdvice"),
      description: t("aiMentor.hiringAdviceDesc"),
      action: () => sendMessage(t("aiMentor.hiringAdviceRequest")),
      gradient: "linear-gradient(135deg, var(--gradient-blue-start, #58a6ff) 0%, var(--gradient-blue-end, #1f6feb) 100%)",
    },
    {
      icon: <FaLightbulb />,
      title: t("aiMentor.applicationTrends"),
      description: t("aiMentor.applicationTrendsDesc"),
      action: () => sendMessage(t("aiMentor.applicationTrendsRequest")),
      gradient: "linear-gradient(135deg, var(--gradient-blue-start, #58a6ff) 0%, var(--gradient-blue-end, #1f6feb) 100%)",
    },
    {
      icon: <FaFileAlt />,
      title: t("aiMentor.candidateAnalysis"),
      description: t("aiMentor.candidateAnalysisDesc"),
      action: () => sendMessage(t("aiMentor.candidateAnalysisRequest")),
      gradient: "linear-gradient(135deg, var(--gradient-blue-start, #58a6ff) 0%, var(--gradient-blue-end, #1f6feb) 100%)",
    },
  ];
      ...
      <div className={styles.mainContent}>
        <div className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <div>
              <h1 className={styles.title}>{t("aiMentor.companyTitle")}</h1>
              <p className={styles.subtitle}>
                {t("aiMentor.companySubtitle")}
              </p>
            </div>
          </div>
          {messages.length > 0 && (
        ...
        {messages.length === 0 && (
          <div className={styles.welcomeSection}>
            ...
            <h2>{t("aiMentor.companyWelcomeTitle")}</h2>
            <p>
              {t("aiMentor.companyWelcomeDescription")}
            </p>
